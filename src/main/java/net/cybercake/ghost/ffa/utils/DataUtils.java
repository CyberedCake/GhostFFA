...
public class DataUtils {
    ...
    public static void saveCustomYml(String fileName) {
        try {
            File customYml = new File(Main.getPlugin().getDataFolder() + "/" + fileName + ".yml");
    ...
    public static void createDirectory(String directory, boolean usePluginDirectory) {
        try {
            ...
            if(usePluginDirectory) {
                theDir = new File(Main.getPlugin().getDataFolder() + "/" + directory);
            ...
            Bukkit.getLogger().severe(" ");
            if(usePluginDirectory) {
                Bukkit.getLogger().severe("Failed to create directory (" + Main.getPlugin().getDataFolder() + directory + "). Error: " + e.toString());
            } else if (!usePluginDirectory){
    ...
    public static String[] getFilesInPluginDirectory(String directory) {
        try {
            String[] pathnames;
            File f = new File(Main.getPlugin().getDataFolder() + "/" + directory);
            pathnames = f.list();
            return pathnames;
        } catch (Exception e) {
            Bukkit.getLogger().severe(" ");
    ...
    public static void createNewFile(String fileName) {
        try {
            File f = new File(Main.getPlugin().getDataFolder() + "/" + fileName);
            f.createNewFile();
        } catch (Exception e) {
            Bukkit.getLogger().severe(" ");
